...
const Trivia = ({
  ...
  return (
    <div className="trivial-gradient relative w-[36.469rem] h-[5.906rem] rounded-[7.5px]">
      <div className="flex items-center pt-2">
        ...
        <div className="flex flex-col">
          ...
          <p className="line-clamp-2 mt-[2px] font-normal inter-tight max-w-[16.219rem] text-trivial-md text-trivial-gray-3">
            {description}
          </p>
        </div>
      </div>
